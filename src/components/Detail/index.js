    ...
    return (
      <Block>
        <View className='detail'>
          ...
          <View className='detail-con wp clearfix'>
            <View className='detail-pic'>{pic ? <Image src={rePic} /> : null}</View>
              ...
              <View className='detial-title'>
                ...
                <View className='detial-title__span'>
                  ...
                  {mcid.length > 0
                    ? mcid.map(item =>
                        item.title ? (
                          <Text className='detial-title__span-text' key={item.id}>
                            {item.title}
                          </Text>
                        ) : null
                      )
        ...
        <View className='detail-nav'>
          <View className='active'><Text>详情</Text></View>
